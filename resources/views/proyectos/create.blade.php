            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Crear Proyecto</h1>
                ...
                <div class="bg-white dark:bg-slate-800 shadow-sm rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <form action="{{ route('proyectos.store') }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        ...
                        <div>
                            <flux:field>
                                ...
                                <flux:textarea 
                                    ...
                                    rows="4"
                                    class="w-full">{{ old('descripcion') }}</flux:textarea>
                            ...
                            <div>
                                <flux:field>
                                    ...
                                    <flux:select name="fase_actual" class="w-full">
                                        ...
                                        <option value="propuesta" {{ old('fase_actual') == 'propuesta' ? 'selected' : '' }}>Propuesta</option>
                                        <option value="analisis" {{ old('fase_actual') == 'analisis' ? 'selected' : '' }}>Análisis</option>
                                        <option value="diseño" {{ old('fase_actual') == 'diseño' ? 'selected' : '' }}>Diseño</option>
                                        <option value="desarrollo" {{ old('fase_actual') == 'desarrollo' ? 'selected' : '' }}>Desarrollo</option>
                                        <option value="prueba" {{ old('fase_actual') == 'prueba' ? 'selected' : '' }}>Prueba</option>
                                        <option value="implantacion" {{ old('fase_actual') == 'implantacion' ? 'selected' : '' }}>Implantación</option>
                                    </flux:select>
